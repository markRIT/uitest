...
sendaddr_name = read_config.getValue('projectConfig','sendaddr_name')
sendaddr_pswd = read_config.getValue('projectConfig','sendaddr_pswd')
recvaddress = ['17688894616@163.com','2442452063@qq.com']
